...
import com.alinesno.infra.ops.telemetry.mapper.MetricsExponentialHistogramMapper;
import com.alinesno.infra.ops.telemetry.service.IMetricsExponentialHistogramService;
...
import static com.alinesno.infra.ops.telemetry.enums.ClickhouseSqls.metricsExponentialHistogramSql;
 ...
 */
@Service
public class MetricsExponentialHistogramServiceImpl extends IBaseServiceImpl<MetricsExponentialHistogram, MetricsExponentialHistogramMapper> implements IMetricsExponentialHistogramService {
    // 日志记录
    private static final Logger log = LoggerFactory.getLogger(MetricsExponentialHistogramServiceImpl.class);
