...
import com.alinesno.infra.ops.telemetry.mapper.TelemetryLogsMapper;
import com.alinesno.infra.ops.telemetry.service.ITelemetryLogsService;
...
/**
 * 表示 TelemetryLogs 的 Service 实现类
 *
 * @version 1.0.0
 * @author luoxiaodong
 */
@Service
public class TelemetryLogsServiceImpl extends IBaseServiceImpl<TelemetryLogs, TelemetryLogsMapper> implements ITelemetryLogsService {
    // 日志记录
    private static final Logger log = LoggerFactory.getLogger(TelemetryLogsServiceImpl.class);
