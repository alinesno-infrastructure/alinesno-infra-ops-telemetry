...
public class TelemetryMetricsHistogram extends InfraBaseEntity {
    ...
    public void setBucketCounts(List<Long> bucketCounts) {
    ...
    public void setExplicitBounds(List<Double> explicitBounds) {
